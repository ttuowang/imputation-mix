...
censor    <- "independent"            # type of censoring distribution
...
var.names <- list(
  d1 = list(
    d = c("A", "X", "Z2_t1","Y1_t3","Y2_t3"),
    r = c("A", "X", "Z1_t1", "Z2_t1","Y1_t3","Y2_t3"),
    c = c("A", "X", "Z1_t1", "Z2_t1","Y1_t3","Y2_t3","Z2_t2"),
    b = c("A", "X", "Z1_t1", "Z2_t1","Y1_t3","Y2_t3","Z2_t2","Y1_t6")
  ),
  d2 = list(
    d = c("A", "X", "Z2_t1","Z2_t2","Y1_t6","Y2_t6"),
    r = c("A", "X", "Z1_t2", "Z2_t1","Z2_t2","Y1_t6","Y2_t6"),
    c = c("A", "X", "Z1_t2", "Z2_t1","Z2_t2","Y1_t6","Y2_t6","Z2_t3"),
    b = c("A", "X", "Z1_t2", "Z2_t1","Z2_t2","Y1_t6","Y2_t6","Z2_t3", "Y1_t9")
  ),
  d3 = list(
    d = c("A", "X", "Z2_t1","Z2_t2","Z2_t3","Y1_t9","Y2_t9"),
    r = c("A", "X",  "Z1_t3", "Z2_t1","Z2_t2","Z2_t3","Y1_t9","Y2_t9"),
    c = c("A", "X",  "Z1_t3", "Z2_t1","Z2_t2","Z2_t3","Y1_t9","Y2_t9","Z2_t4"),
    b = c("A", "X",  "Z1_t3", "Z2_t1","Z2_t2","Z2_t3","Y1_t9","Y2_t9","Z2_t4","Y1_t12")
  )
)
...
for (i in 1:ns) {
  ...
  mimp.try <- tryCatch({
    for (it in c(1:nimp)) {
      ...
      imp.try <- tryCatch(
        {imp.obj <- imputation(
          event.miss = event.miss, cov.miss = cov.miss,
      ...
      event.imp <- imp.obj$event.imp
      cov.imp <- imp.obj$cov.imp
...
# Y1_t12.A0.TRUE <- 0.498
# Y1_t12.A1.TRUE <- 0.000186
# Y2_t12.A0.TRUE <- 0.501
# Y2_t12.A1.TRUE <- 0.355
...
#load(file=glue("./sim_11_14_ind.RData"))
